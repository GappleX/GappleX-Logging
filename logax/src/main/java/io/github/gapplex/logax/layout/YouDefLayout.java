...
public class YouDefLayout implements Layout{
    private final List<Object> format;

    public YouDefLayout(String format, EventField... eventFields){
    ...
    public String format(LogEvent event) {
        ...
        for (Object o : format){
            if (o instanceof EventField){
                EventField eventField = (EventField) o;
                sb.append(eventField.format(event));
            } else {
                sb.append(o);
            }
        }
